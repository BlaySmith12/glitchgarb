...
class StorageService {
    ...
    loginUser(email, password) {
        ...
        if (user) {
            ...
            // Merge guest cart with user cart (if using backend)
            this.mergeGuestCart();
    ...
    mergeGuestCart() {
        try {
            ...
            // For localStorage-only mode, just keep the cart as is
            // If backend is available, this would be overridden by api-service.js
            console.log('Guest cart preserved for user');
            return { success: true, message: 'Cart preserved' };
        } catch (e) {
