...
class CampaignSlider {
    ...
    render() {
        const showNavigation = this.slides.length > 1;
...
class SiteFooter {
    ...
    render() {
        ...
        footer.style.cssText = 'margin-top: 8rem; background: linear-gradient(180deg, transparent 0%, rgba(0,0,0,0.3) 100%); border-top: 1px solid var(--border-color);';
                ...
                <div class="container">
                    <div class="footer-grid"
                        ...
                        <div class="footer-brand">
                            <a href="/" class="logo"><img src="logo.png" alt="GLITCHGARB"
                                    style="height: 32px;"></a>
                            <p
                        ...
                        <div class="footer-column">
                            ...
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                <li style="margin-bottom: 0.75rem;"><a href="/shop"
                                ...
                                <li style="margin-bottom: 0.75rem;"><a href="/collections"
                                        style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.85rem; transition: color 0.3s;"
                                        onmouseover="this.style.color='#fff'"
                        ...
                        <div class="footer-column">
                            <h4
                                ...
                                COMPANY</h4>
                            <ul style="list-style: none; padding: 0; margin: 0;">
                                <li style="margin-bottom: 0.75rem;"><a href="/about"
                                        style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.85rem; transition: color 0.3s;"
                                        onmouseover="this.style.color='#fff'"
                                ...
                                <li style="margin-bottom: 0.75rem;"><a href="/careers"
                                        style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.85rem; transition: color 0.3s;"
                                        onmouseover="this.style.color='#fff'"
                                        onmouseout="this.style.color='rgba(255,255,255,0.6)'">Careers</a></li>
                                <li style="margin-bottom: 0.75rem;"><a href="/privacy"
                                        style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.85rem; transition: color 0.3s;"
                                        onmouseover="this.style.color='#fff'"
                                        onmouseout="this.style.color='rgba(255,255,255,0.6)'">Privacy Policy</a></li>
                                <li style="margin-bottom: 0.75rem;"><a href="/terms"
                                        style="color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.85rem; transition: color 0.3s;"
                                        onmouseover="this.style.color='#fff'"
